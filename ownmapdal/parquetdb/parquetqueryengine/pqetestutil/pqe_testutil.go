...
//go:embed osm_nodes_test_schema.json
var OsmNodesSchema string

var testNodes = []testNodeType{
	{ID: 1, Lat: 10, Lon: -10, Tags: tagMapType{"place": "city", "name": "my city"}},
	{ID: 2, Lat: 10.1, Lon: -10.1, Tags: tagMapType{"place": "town", "name": "my town"}},
	{ID: 3, Lat: 10.2, Lon: -10.2},
	{ID: 4, Lat: 10.3, Lon: -10.3, Tags: tagMapType{"highway": "motorway"}},
